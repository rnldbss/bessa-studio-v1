...
export function Project({
  ...
  return (
    <motion.div
      ...
      className={`${tailClass} relative z-20 col-start-2 col-end-12 row-start-1 row-end-1  flex max-w-[1150px] flex-col justify-center gap-4 sm:col-start-3 lg:col-start-3 xl:col-start-3 xl:justify-self-start`}
    >
